                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={submitForm} className="p-4 bg-white shadow dark:bg-gray-800 sm:p-8 sm:rounded-lg">
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_status" name="status" className="mt-1 block w-full" onChange={(event) => setData("status", event.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_priority" name="priority" className="mt-1 block w-full" onChange={(event) => setData("priority", event.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_assigned_to" name="assigned_to" className="mt-1 block w-full" onChange={(event) => setData("assigned_to", event.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_project_id" name="project_id" className="mt-1 block w-full" onChange={(event) => setData("project_id", event.target.value)}>
